      ...
      <div className="container mx-auto px-4">
        <div className="glass-card rounded-[2rem] p-8 md:p-16 border-primary/10 bg-gradient-to-br from-card to-secondary/50">
          <div className="grid lg:grid-cols-2 gap-16">
            <div>
              <h2 className="font-headline text-accent text-sm font-bold uppercase tracking-[0.3em] mb-4">Colaboración</h2>
              <h3 className="font-headline text-4xl md:text-5xl font-bold mb-8">Hablemos de tu próximo ecosistema digital</h3>
              <p className="text-muted-foreground text-lg mb-10 leading-relaxed">
                ¿Buscas una inversión segura que entienda tanto el código como el negocio? Estoy lista para optimizar tu estrategia.
              </p>

              <div className="space-y-6">
                <a href="mailto:contact@sandovalstrategics.com" className="flex items-center gap-4 group">
            ...
            <div className="bg-background/50 p-8 rounded-2xl border border-white/5">
              <form className="space-y-4" onSubmit={(e) => e.preventDefault()}>
                ...
                <div className="space-y-2">
                  ...
                  <Input placeholder="Nueva colaboración técnica" className="bg-background/80 border-white/10" />
                </div>
                <div className="space-y-2">
                  <label className="text-xs font-bold uppercase tracking-widest text-muted-foreground">Mensaje</label>
                  <Textarea placeholder="Cuéntame sobre tu proyecto..." className="min-h-[150px] bg-background/80 border-white/10" />
                </div>
